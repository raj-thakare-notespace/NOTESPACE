...
import com.example.notespace.adapters.DocPostAdapter
...
class DocumentPostsActivity : AppCompatActivity() {

    lateinit var recyclerView : RecyclerView
    lateinit var adapter : DocPostAdapter
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_document_posts)
        ...
        adapter = DocPostAdapter(this,arrayList)
