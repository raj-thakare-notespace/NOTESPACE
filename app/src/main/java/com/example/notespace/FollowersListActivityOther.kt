...
class FollowersListActivityOther : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_followers_list_other)

        val userId = intent.getStringExtra("uid")

        allChatAdapter = FollowingFollowersAdapter(this,arrayListAllFollowers)

        toolbar = findViewById(R.id.followersListToolBarOther)
        ...
        recyclerView = findViewById(R.id.followersListRVOther)
